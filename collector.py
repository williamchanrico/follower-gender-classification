...
def get_all_followers_comments(client, username, follower_limit=math.inf, media_per_follower_limit=25, comments_per_media_limit=250):
...
def get_followers_id_list(client, username, limit=10000):
    ...
    while True:
        ...
        data = filter(lambda x: x["is_private"] == False, client.LastJson.get("users", []))
